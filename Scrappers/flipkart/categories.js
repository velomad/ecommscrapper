module.exports = [
	{
		men: [
			...
			{
				Fossil:
					"watches/fossil~brand/pr?sid=r18&otracker=nmenu_sub_Men_0_Fossil",
			},
			{
				Sonata:
					"watches/sonata~brand/pr?sid=r18&otracker=nmenu_sub_Men_0_Sonata",
			},
			{
				Backpacks:
			...
			// classnames are different in the following categories
		...
		women: [
			...
			{
				Dresses:
					"clothing-and-accessories/dresses-and-gown/dress/women-dress/pr?sid=clo,odx,maj,jhy&otracker=categorytree&otracker=nmenu_sub_Women_0_Dresses",
			},
			{
				Jeans:
					"clothing-and-accessories/bottomwear/jeans/women-jeans/pr?sid=clo,vua,k58,4hp&otracker=categorytree&otracker=nmenu_sub_Women_0_Jeans",
			},
			{
				Shorts:
					"clothing-and-accessories/bottomwear/shorts/women-shorts/pr?sid=clo,vua,e8g,hbd&otracker=categorytree&otracker=nmenu_sub_Women_0_Shorts",
			},
			{
				Skirts:
			...
			{
				Bras:
					"clothing-and-accessories/innerwear/bra/women-bra/pr?sid=clo,qfl,v5v,kzg&otracker=categorytree&otracker=nmenu_sub_Women_0_Bras",
			},
			{
				Panties:
					"clothing-and-accessories/innerwear/panties/women-panties/pr?sid=clo,qfl,q5u,la2&otracker=categorytree&otracker=nmenu_sub_Women_0_Panties",
			},
			{
				"Lingerie Sets":
			...
			{
				"Party Dresses":
					"clothing-and-accessories/dresses-and-gown/dress/women-dress/pr?sid=clo%2Codx%2Cmaj%2Cjhy&otracker=categorytree&p%5B%5D=facets.occasion%255B%255D%3DParty&otracker=nmenu_sub_Women_0_Party%20Dresses",
			},
			{
				"Sports Wear":
					"clothing-and-accessories/~cs-xy1011hvj1/pr?sid=clo&collection-tab-name=Sports%20and%20Gym%20Wear&otracker=nmenu_sub_Women_0_Sports%20Wear",
			},
			{
				"Winter Wear":
					"clothing-and-accessories/winter-wear/pr?sid=clo%2Cqvw&otracker=categorytree&p%5B%5D=facets.ideal_for%255B%255D%3DWomen&otracker=nmenu_sub_Women_0_Winter%20Wear",
			},
			{
				Sarees:
			...
			{
				"Dress Material":
					"clothing-and-accessories/fabric/dress-material/women-dress-material/pr?sid=clo,qfi,xcx,ms4&otracker=categorytree&otracker=nmenu_sub_Women_0_Dress%20Material",
			},
			{
				"Lehenga Choli":
					"clothing-and-accessories/lehenga-choli/women-lehenga-choli/pr?sid=clo,hlg,wrp&otracker=categorytree&otracker=nmenu_sub_Women_0_Lehenga%20Choli",
			},
			{
				Blouse:
			...
			{
				Gowns:
					"clothing-and-accessories/dresses-and-gown/gown/women-gown/pr?sid=clo,odx,od7,0xx&otracker=categorytree&otracker=nmenu_sub_Women_0_Gowns",
			},
			{
				Dupattas:
			...
			{
				Palazzos:
					"clothing-and-accessories/ethnic-wear/palazzo/pr?sid=clo,cfv,mn6&otracker=categorytree&otracker=nmenu_sub_Women_0_Palazzos",
			},
			{
				Shararas:
			...
			{
				"Dhoti Pants":
					"clothing-and-accessories/ethnic-wear/dhoti-pants/women-dhoti-pants/pr?sid=clo,cfv,emd,on4&otracker=categorytree&otracker=nmenu_sub_Women_0_Dhoti%20Pants",
			},
			{
				"Ethnic Trousers":
			...
			{
				Footwear:
					"womens-footwear/pr?sid=osp,iko&otracker=nmenu_sub_Women_0_Footwear",
			},
			{
				Sandals:
					"womens-footwear/~womens-sandals/pr?sid=osp,iko&otracker=nmenu_sub_Women_0_Sandals",
			},
			{
				Flats:
					"womens-footwear/flats/pr?sid=osp,iko,9d5&otracker=nmenu_sub_Women_0_Flats",
			},
			{
				Heels:
					"womens-footwear/heels/pr?sid=osp,iko,6q1&otracker=nmenu_sub_Women_0_Heels",
			},
			{
				Wedges:
					"womens-footwear/wedges/pr?sid=osp,iko,jpm&otracker=nmenu_sub_Women_0_Wedges",
			},
			{
				Shoes:
					"womens-footwear/~sports-casual-shoes/pr?&sid=osp%2Ciko&otracker=nmenu_sub_Women_0_Shoes",
			},
			{
				"Sports Shoes":
					"womens-footwear/sports-shoes/pr?sid=osp,iko,d20&otracker=nmenu_sub_Women_0_Sports%20Shoes",
			},
			{
				"Casual Shoes":
					"womens-footwear/casual-shoes/pr?sid=osp,iko,sx7&otracker=nmenu_sub_Women_0_Casual%20Shoes",
			},
			{
				Boots:
					"womens-footwear/boots/pr?sid=osp%2Ciko%2Cxgp&otracker=nmenu_sub_Women_0_Boots",
			},
			{
				Ballerinas:
			...
			// {
			// 	"Smart Watches":
			// 		"wearable-smart-devices/smart-watches/pr?sid=ajy,buh&p%5B%5D=facets.filter_standard%255B%255D%3D1&facets.availability[]=Exclude+Out+of+Stock&otracker=CLP_lhs&otracker=nmenu_sub_Women_0_Smart%20Watches",
			// },
			// {
			// 	"Personal Care Appliances":
			// 		"health-personal-care-appliances/personal-care-appliances/~personalcareforwomen/pr?sid=zlw%2C79s&otracker=nmenu_sub_Women_0_Personal%20Care%20Appliances",
			// },
			// {
			// 	"Hair Straightners":
			// 		"health-personal-care-appliances/personal-care-appliances/hair-straighteners/pr?sid=zlw,79s,dk5&otracker=nmenu_sub_Women_0_Hair%20Straightners",
			// },
			// {
			// 	"Hair Dryers":
			// 		"health-personal-care-appliances/personal-care-appliances/hair-dryers/pr?sid=zlw,79s,mh8&otracker=nmenu_sub_Women_0_Hair%20Dryers",
			// },
			// {
			// 	Epilators:
			// 		"health-personal-care-appliances/personal-care-appliances/epilators/pr?sid=zlw,79s,k32&otracker=nmenu_sub_Women_0_Epilators",
			// },
			// {
			// 	"Beauty & Grooming":
			// 		"beauty-and-grooming/pr?sid=g9b&p[]=facets.serviceability%5B%5D%3Dtrue&otracker=categorytree&otracker=nmenu_sub_Women_0_Beauty%20%26%20Grooming",
			// },
			// {
			// 	"Make Up":
			// 		"beauty-and-grooming/makeup/pr?sid=g9b,ffi&p[]=facets.serviceability%5B%5D%3Dtrue&otracker=categorytree&otracker=nmenu_sub_Women_0_Make%20Up",
			// },
			// {
			// 	"Skin Care":
			// 		"beauty-and-grooming/body-face-skin-care/body-and-face-care/pr?sid=g9b%2Cema%2C5la&p%5B%5D=facets.ideal_for%255B%255D%3DMen%2B%2526%2BWomen&otracker=categorytree&p%5B%5D=facets.ideal_for%255B%255D%3DWomen&p%5B%5D=facets.ideal_for%255B%255D%3DUnisex&p%5B%5D=facets.serviceability%5B%5D%3Dtrue,&otracker=nmenu_sub_Women_0_Skin%20Care",
			// },
			// {
			// 	"Hair Care":
			// 		"beauty-and-grooming/hair-care-and-accessory/pr?sid=g9b,lcf&p[]=facets.serviceability%5B%5D%3Dtrue&otracker=categorytree&otracker=nmenu_sub_Women_0_Hair%20Care",
			// },
			// {
			// 	"Bath & Spa":
			// 		"beauty-and-grooming/bath-shower/pr?sid=g9b,5nz&p[]=facets.serviceability%5B%5D%3Dtrue&otracker=categorytree&otracker=nmenu_sub_Women_0_Bath%20%26%20Spa",
			// },
			// {
			// 	"Deodorants & Perfumes":
			// 		"beauty-and-grooming/fragrances/pr?sid=g9b%2C0yh&p%5B%5D=facets.ideal_for%255B%255D%3DWomen&otracker=categorytree&p%5B%5D=facets.ideal_for%255B%255D%3DMen%2B%2526%2BWomen&p%5B%5D=facets.serviceability%5B%5D%3Dtrue&otracker=nmenu_sub_Women_0_Deodorants%20%26%20Perfumes",
			// },
			{
				Jewellery: "jewellery/pr?sid=mcr&otracker=nmenu_sub_Women_0_Jewellery",
			},
			// {
			// 	"Artificial Jewellery":
			// 		"fashion-jewellery-store?otracker=nmenu_sub_Women_0_Artificial%20Jewellery",
			// },
			{
				"Silver Jewellery":
					"jewellery/silver-jewellery/pr?sid=mcr,tfz&otracker=nmenu_sub_Women_0_Silver%20Jewellery",
			},
			{
				"Precious Jewellery":
					"jewellery/precious-jewellery/pr?sid=mcr,ykh&otracker=nmenu_sub_Women_0_Precious%20Jewellery",
			},
			{
				"Coins and Bars":
					"jewellery/gemstones-coins-bars/pr?sid=mcr,73x&p[]=facets.serviceability%5B%5D%3Dtrue&otracker=categorytree&otracker=nmenu_sub_Women_0_Coins%20and%20Bars",
			},
			// {
			// 	Accessories:
			// 		"women-handbags-store?otracker=nmenu_sub_Women_0_Accessories",
			// },
			// {
			// 	Handbags:
			// 		"bags-wallets-belts/handbags-clutches/handbags/pr?sid=reh,ihu,m08&otracker=categorytree&otracker=nmenu_sub_Women_0_Handbags",
			// },
			{
				"Shoulder Bags":
					"bags-wallets-belts/handbags-clutches/shoulder-bags/pr?sid=reh,ihu,1gy&otracker=categorytree&otracker=nmenu_sub_Women_0_Shoulder%20Bags",
			},
			{
				Totes:
					"bags-wallets-belts/handbags-clutches/totes/pr?sid=reh,ihu,v57&otracker=categorytree&otracker=nmenu_sub_Women_0_Totes",
			},
			{
				"Sling bags":
					"bags-wallets-belts/handbags-clutches/sling-bags/pr?sid=reh,ihu,mf2&otracker=categorytree&otracker=nmenu_sub_Women_0_Sling%20bags",
			},
			{
				Clutches:
			...
			{
				Sunglasses:
					"sunglasses/pr?p%5B%5D=facets.ideal_for%255B%255D%3DMen%2B%2526%2BWomen&sid=26x&otracker=nmenu_sub_Women_0_Sunglasses&p%5B%5D=facets.ideal_for%255B%255D%3DWomen&otracker=nmenu_sub_Women_0_Sunglasses",
			},
			{
				Frames:
					"eyewear/frames/pr?count=40&p%5B%5D=facets.ideal_for%255B%255D%3DUnisex&p%5B%5D=facets.ideal_for%255B%255D%3DWomen&sid=u73%2Fh4k&otracker=nmenu_sub_Women_0_Frames",
			},
		],
	},
];
